...
Also, the pyhcl2 supporting has been added by Andrei Maruha and to install this module, use the next command:
```
$ wget -qO- https://files.pythonhosted.org/packages/cf/3f/3ff50ca76d5a44a7043b791d3876b5e693b6a2f64db832539e3f162e8323/python-hcl2-0.2.5.tar.gz | tar xfvz - && cd python-hcl2-* && python3 setup.py install
```

If you want to use another version of the software, go to the official site and download it from [https://pypi.org/project/python-hcl2](https://pypi.org/project/python-hcl2/#files)
...
optional arguments:
  ...
  --hcl-version HCL VERSION
                        Set version of hcl to use for parsing terraform
...
```bash
$ python3 generate_docs_pyhcl.py -m="/Users/captain/Projects/Terraform/aws/modules/nlb" -e="/Users/captain/Projects/Terraform/aws/examples/nlb"
"OUTPUT_nlb.md" file has been created: /Users/captain/Projects/Python/Terraform
============================================================
========================= FINISHED =========================
============================================================
...
Or, if you want to use pyhcl2 version, use the next command:
```bash
$ python3 generate_docs_pyhcl.py -m="/Users/captain/Projects/Terraform/aws/modules/nlb" -e="/Users/captain/Projects/Terraform/aws/examples/nlb" --hcl-version=2
"OUTPUT_nlb.md" file has been created: /Users/captain/Projects/Python/Terraform
============================================================
========================= FINISHED =========================
============================================================
...
Where:
- python3 - Python (I'm using `Python 3.7.6`).
- generate_docs_pyhcl.py - The script's name.
- -m="/Users/captain/Projects/Terraform/aws/modules/nlb" - It's path to some module (For example: nlb).
- -e="/Users/captain/Projects/Terraform/aws/examples/nlb" - It's path to where your project is (For example I used that path).
...
Refactoring and added features by Andrei Maruha.
